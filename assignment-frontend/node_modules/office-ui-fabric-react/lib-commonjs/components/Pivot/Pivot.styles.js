        ...
        linkIsSelected: tslib_1.__spreadArrays([
            ...
            rootIsTabs && {
                ...
                selectors: (_c = {
                    ...
                    _c[Styling_1.HighContrastSelector] = tslib_1.__assign({ fontWeight: Styling_1.FontWeights.semibold, color: 'HighlightText', background: 'Highlight' }, Styling_1.getHighContrastNoAdjustStyle()),
                    _c),
            },
        ]),
        linkContent: [
