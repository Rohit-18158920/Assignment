    ...
    return {
        ...
        checkbox: [
            ...
            (_o = {
                ...
                _o[Styling_1.HighContrastSelector] = tslib_1.__assign({ borderColor: 'WindowText' }, Styling_1.getHighContrastNoAdjustStyle()),
                _o),
            indeterminate && {
        ...
        checkmark: [
            ...
            (_s = {
                ...
                _s[Styling_1.HighContrastSelector] = tslib_1.__assign({ color: disabled ? 'GrayText' : 'Window' }, Styling_1.getHighContrastNoAdjustStyle()),
                _s),
        ],
        text: [
            classNames.text,
            (_t = {
                ...
                _t[Styling_1.HighContrastSelector] = tslib_1.__assign({ color: disabled ? 'GrayText' : 'WindowText' }, Styling_1.getHighContrastNoAdjustStyle()),
                _t),
            !reversed
                ? {
                    marginLeft: 4,
